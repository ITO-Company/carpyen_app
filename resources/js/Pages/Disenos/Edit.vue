...
const form = useForm({
    proyecto_id: props.diseno.proyecto_id,
    descripcion: props.diseno.descripcion,
    estado: props.diseno.estado,
    fecha_inicio: props.diseno.fecha_inicio,
    fecha_fin: props.diseno.fecha_fin
});

const submit = () => {
    form.put(route('disenos.update', props.diseno.id));
};
</script>
