...
const form = useForm({
    ...
    user_id: props.diseno.user_id || '',
    descripcion: props.diseno.descripcion || '',
    estado: props.diseno.estado || 'pendiente',
    fecha_inicio: props.diseno.fecha_inicio ? props.diseno.fecha_inicio.substring(0, 10) : '',
    fecha_fin: props.diseno.fecha_fin ? props.diseno.fecha_fin.substring(0, 10) : ''
});

const submit = () => {
    form.put(route('cotizaciones.disenos.update', [props.cotizacion.id, props.diseno.id]));
};
</script>
            ...
            <div class="flex justify-between items-center">
                <div class="flex flex-col gap-1">
                    ...
                    <p class="text-sm" style="color: var(--theme-text-secondary)">
                        {{ proyecto.nombre }} - Cotización #{{ cotizacion.id }} - Diseño #{{ diseno.id }}
                    </p>
                </div>
                    ...
                    <form @submit.prevent="submit">
                        ...
                        <div class="form-actions">
                            ...
                            >
                                ...
                                <span v-else>Actualizar Diseño</span>
                            </button>
                        </div>
                    </form>
                </div>
