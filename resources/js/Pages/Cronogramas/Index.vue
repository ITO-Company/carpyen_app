                ...
                <div class="card fade-in">
                    <div class="overflow-x-auto">
                        <table class="table">
                            ...
                            <tbody>
                                <tr v-for="cronograma in cronogramas.data" :key="cronograma.id">
                                    <td>{{ cronograma.id }}</td>
                                    <td class="font-medium">{{ cronograma.proyecto?.nombre || '-' }}</td>
                                ...
                                <tr v-if="!cronogramas.data || cronogramas.data.length === 0">
                                    <td colspan="6" class="text-center py-8" style="color: var(--theme-text-secondary)">
                    ...
                    <!-- Paginación -->
                    <div v-if="cronogramas.links" class="mt-6 flex justify-between items-center">
