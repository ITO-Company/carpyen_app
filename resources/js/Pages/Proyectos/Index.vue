        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="card fade-in">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr v-for="proyecto in proyectos.data" :key="proyecto.id">
                                    ...
                                    <td>{{ proyecto.vendedor?.name || 'Sin asignar' }}</td>
                                    <td>{{ proyecto.ubicacion || '-' }}</td>
                                    <td>
                                        <span :class="['badge', estadoColors[proyecto.estado]]">
                                ...
                                <tr v-if="!proyectos.data || proyectos.data.length === 0">
                    ...
                    <!-- Paginación -->
                    <div v-if="proyectos.links" class="mt-6 flex justify-between items-center">
                        <div style="color: var(--theme-text-secondary); font-size: var(--font-size-sm)">
                            Mostrando {{ proyectos.from }} a {{ proyectos.to }} de {{ proyectos.total }} resultados
                        </div>
                        <div class="flex gap-2">
                            <Link
