        ...
        <div class="py-12">
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                <div class="mb-6 flex gap-3">
                    <Link :href="route('proveedores.edit', proveedor.id)" class="btn btn-primary">
                ...
                <div class="card fade-in" v-if="proveedor.productos && proveedor.productos.length > 0">
                    <h3 style="color: var(--theme-text-primary); font-size: 18px; font-weight: 600; margin-bottom: 20px;">
                ...
                <div v-else class="card fade-in">
                    <p class="text-center" style="color: var(--theme-text-secondary); padding: 40px;">
