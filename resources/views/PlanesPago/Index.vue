<template>
    ...
    >
        <div class="max-w-7xl mx-auto">
            ...
            <div class="flex justify-between items-center mb-8">
                <div>
                    ...
                    <p class="text-gray-600 mt-2">
                        Gestiona los planes de pago de tus proyectos
                    </p>
                </div>
                <Link
            ...
            <div v-if="planesPago.data.length > 0" class="grid gap-6">
                <div
            ...
            <div v-else class="text-center py-16 bg-white rounded-lg shadow">
                ...
                <p class="text-gray-600 mb-6">
                    Comienza creando un nuevo plan de pago para tus proyectos
                </p>
                <Link
                    href="/planesPago/create"
                    class="inline-flex items-center px-6 py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition font-semibold"
            ...
            >
                <div
                    class="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-96 overflow-y-auto"
                    @click.stop
                >
                    <div
                        class="sticky top-0 bg-indigo-600 text-white p-6 flex justify-between items-center"
                    >
                    ...
                    <div class="p-6">
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg mb-6">
                            ...
                            <div class="grid grid-cols-3 gap-4">
                                ...
                                <div>
                                    <p class="text-gray-600 text-sm">Pagado</p>
