        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-600 mt-2">
                    Defina el plan de pagos para un proyecto
                </p>
            </div>
            ...
            <form @submit.prevent="submitForm" class="space-y-8">
                ...
                <div class="flex gap-4">
                    ...
                    >
                        <span v-if="!processing">Crear Plan de Pago</span>
...
const actualizarProyecto = () => {
    // Aquí podrías cargar datos adicionales del proyecto si es necesario
};
